...
<?php
	if (isset($_POST["btn_submit"])) {
		...
		header("Location: http://localhost/calo-calc/calo-calc/admin/quan-ly-thanh-vien.php");
	}
	...
	function make_permission_dropdown($id){
		...
		$select = '<select id="permission" name="permission">
						...
						<option value="0" '.$select_1.'>User</option>
...
?>
	...
	?>
	<form  class="content-wrapper" style="min-height: 365px; padding-left: 15px;" action="chinh-sua-thanh-vien.php" method="post">
		<table>
			<tr>
				<td colspan="2">
					<h3>Edit information account</h3>
			...
			<tr>
				<td colspan="2" align="center"><input type="submit" name="btn_submit" value="Update"></td>
			</tr>
