            ...
            <tbody><tr valign="top">
              <td width="140" class="center" style="padding:2px 0px 0px 12px">
                ...
                <div class="imgFrame" align="center">
                  ...
                  <div style="margin:5px">
                    <a href="/Default.aspx?pa=recimd&amp;recipeid=5111406">
                      <img border="0" src="https://m.ftscrt.com/static/recipe/a8331dcb-2b58-4d73-a3ba-ba2e6175e303.jpg" width="130" class="photo">
                    </a>
                  </div>
                ...
                <div class="bottom">
                  ...
                  <div id="servings" class="leftBox">
                    <div class="label">Yields:</div><div class="yield">14 servings</div>
                  </div>
                  
                  
                    <div id="cooktime" class="leftBox">
                      
                        <div class="label">Prep Time:</div><div class="prepTime">5 mins<span class="value-title" title="PT5M"></span></div>
                      
                        <div class="label">Cook Time:</div><div class="cookTime">2 mins<span class="value-title" title="PT2M"></span></div>
              ...
              <td width="*" class="center" style="width:100%">
                ...
                <div style="margin-top:5px;margin-bottom:10px">
                  <span class="summary">Quick and easy yummy chocolate cookies that require no baking.</span>
                  <h3 id="ingredients" class="borderBottom" style="margin-bottom:10px;padding-bottom:0;">Ingredients</h3> 
                  <ul class="plain ingredients">
                <li class="ingredient"><a title="No Calorie Sweetener (Made with Sucralose)" href="/calories-nutrition/great-value/no-calorie-sweetener-(made-with-sucralose)?entryname=great+value+no+calorie+sweetner&amp;portionid=0&amp;portionamount=16.000">Calories: 84 | Fat: 4.5g | Carbs: 10.71g | Protein: 2.36g</a></li>   
                      <li class="ingredient"><a title="No Calorie Sweetener (Made with Sucralose)" href="/calories-nutrition/great-value/no-calorie-sweetener-(made-with-sucralose)?entryname=great+value+no+calorie+sweetner&amp;portionid=0&amp;portionamount=16.000">16 packets no calorie sweetener</a></li>
                    
                      <li class="ingredient"><a title="Natural Unsweetened Cocoa" href="/calories-nutrition/hersheys/natural-unsweetened-cocoa?entryname=unsweetened+cocoa&amp;portionid=0&amp;portionamount=6.000">6 tbsp unsweetened cocoa</a></li>
                    
                      <li class="ingredient"><a title="100% Whole Grain Oatmeal" href="/calories-nutrition/quaker/100-whole-grain-oatmeal?entryname=quaker+oats&amp;portionid=0&amp;portionamount=3.000">1 1/2 cups oats</a></li>
                    
                      <li class="ingredient"><a title="Sugar Free French Vanilla Liquid Coffee Creamer" href="/calories-nutrition/coffee-mate/sugar-free-french-vanilla-liquid-coffee-creamer?entryname=coffee+mate+sugar+free+french+vanilla+creamer&amp;portionid=0&amp;portionamount=6.000">6 tbsp sugar free french vanilla liquid coffee creamer</a></li>
                    
                      <li class="ingredient"><a title="Caramel Almond Spread" href="/calories-nutrition/maranatha/caramel-almond-spread?entryname=Caramel+almond+spread+maranatha&amp;portionid=0&amp;portionamount=3.000">6 tbsp caramel almond spread</a></li>
                    
                  </ul>
                  
                  <h3 id="directions" class="borderBottom" style="margin-bottom:10px;padding-bottom:0;">Directions</h3>
                  <ol class="noind instructions">
                  <li class="instruction">Stir together sweetener, cocoa and creamer in 4-cup glass measure or medium microwave-safe bowl. </li><li class="instruction">Microwave on high for 1 to 1 1/4 minutes or until boiling, stirring once.</li><li class="instruction">Stir in caramel almond spread until blended. Stir in oats until combined.</li><li class="instruction">Drop by spoonful's onto a waxed paper-lined plate.</li><li class="instruction">Cool in freezer for 10 minutes before serving</li>
                  </ol>
                  ...
                  <div class="bluebg">
                  248  members have added this recipe to their cookbook.
                  </div>
...
<table class="greybox">
  ...
  <table class="generic">
     ...
     <img src="/../../calo-calc/calo-calc/image/8.png">
</div>
